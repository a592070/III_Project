								...
								<div class="card-body">
									<p class="mb-5">
										...
										their prevalent use in JavaScript plugins) with Bootstrap <a
											href="http://getbootstrap.com/docs/4.1/content/tables/"
								...
								<div class="card-body">
									<p class="mb-5">
										...
										&lt;tbody&gt;. Read bootstrap documentation for <a
											href="http://getbootstrap.com/docs/4.1/content/tables/#striped-rows"
											target="_blank"> more details.</a>
									</p>
							...
							<div class="card card-default">
								...
								<div class="card-body">
									<p class="mb-5">
										...
										for borders on all sides of the table and cells. Read
										bootstrap documentation for <a
											href="http://getbootstrap.com/docs/4.1/content/tables/#bordered-table"
											target="_blank"> more details.</a>
									</p>
							...
							<div class="card card-default">
								...
								<div class="card-body">
									<p class="mb-5">
										...
										cells. Read bootstrap documentation for <a
											href="http://getbootstrap.com/docs/4.1/content/tables/#contextual-classes"
											target="_blank"> more details.</a>
									</p>
									<table class="table">
										<thead>
								...
								<div class="card-body">
									<p class="mb-5">
										...
										. Read bootstrap documentation for <a
											href="http://getbootstrap.com/docs/4.1/content/tables/#table-head-options"
											target="_blank"> more details.</a>
									</p>
							...
							<div class="card card-default">
								...
								<div class="card-body">
									<p class="mb-5">
										...
										to make &lt;thead&gt;s appear light or dark gray. Read
										bootstrap documentation for <a
											href="http://getbootstrap.com/docs/4.1/content/tables/#table-head-options"
											target="_blank"> more details.</a>
									</p>
								...
								<div class="card-body pt-0 pb-5">
									<table
										...
										<tbody>
											...
											<tr>
												<td>24541</td>
												<td><a class="text-dark" href=""> Speed 500 Ignite</a>
												</td>
												<td class="d-none d-md-table-cell">1 Unit</td>
