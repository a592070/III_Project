...
<body>
  ...
  <div class="hero-wrap js-fullheight" style="background-image: url('${pageContext.request.contextPath}/direngine-master/images/user-1.jpg');">
      ...
      $.ajax(
        {
          ...
          url: '${pageContext.servletContext.contextPath}/user/checkUser',
          dataType: 'json',
